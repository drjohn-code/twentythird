  ...
  return (
    <>
      ...
      <nav className="nav glass">
        <a href="#" className="wordmark" aria-label="TwentyThird">
          <LogoMark />
          <span>TwentyThird</span>
        </a>
        <div className="nav-links">
          <a href="#philosophy">Method</a>
          <a href="#brain">The Work</a>
          <a href="#outcomes">Outcomes</a>
          <a href="#research">About</a>
        </div>
        <div className="nav-right">
          ...
          <a href="/auth/sign-in" className="signin">
            Sign in
          </a>
          <a href="/auth/sign-up" className="pill">
            Start <span>→</span>
          </a>
        </div>
      </nav>
          ...
          <div className="container">
            <div className="footer-grid">
              <div className="footer-brand">
                ...
                <p>
                  Psychodynamic AI for the inner life. A quiet room for
                  serious thinking.
                </p>
              </div>
            ...
            <div className="footer-bot">
              <span>© 2026 TwentyThird labs · all rights reserved</span>
            </div>
          </div>
        </footer>
      </main>
